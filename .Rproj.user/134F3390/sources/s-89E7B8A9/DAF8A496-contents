...
my_path <- "data/raw/"
# covid data
cv <- read_csv(paste0(my_path,'covid_09_29_2020_raw.csv'))
# population data
pop <- read_csv(paste0(my_path,'pop_WDI_2019.csv'))
...
my_path <- "data/clean/"
# COVID data
write_csv( df , paste0(my_path,'covid_pop_09_29_2020_clean.csv'))
